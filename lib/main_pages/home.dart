...
import '../card/adhaar/slider/slide.dart';
...
class _HomeState extends State<Home> {
  ...
  getadmin() async {
    ...
    String username = await prefs.getString('username')??"NA";
    try{
      LoginModel? user = await Users.getUserByUsername(context, username: username, name: s1);
      if(user==null){
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                    ...
                                    child: q(context,"assets/setting.gif","Set Max Word")),
                              ],
                            ),
                            SizedBox(height: 9,),
                          ],
      ...
      return  WillPopScope(
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Center(child: Icon(Icons.security_sharp,color: Colors.red,),),
              SizedBox(height: 10,),
              Center(child: Text("Access Removed",style: TextStyle(fontWeight: FontWeight.w900),)),
              Center(child: Text("SuperAdmin Removed your Access")),
            ],
          )
        ),
      );
